...
When adding a bug to the tracker you should follow the bug reporting guidelines, they can be found in [./Documentation/Resources.md#reporting-a-good-swiftpm-bug](Resources.md).
