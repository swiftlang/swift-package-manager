...
Also if a module map is generated, you can't provide one in the public include directory.

To assist in finding generated header files, the build system adds the `include` directory from the plugin output directory to
