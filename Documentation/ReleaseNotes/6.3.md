...
SwiftBuild is designed to replace the current native build system and brings several key improvements.  You can read more about SwiftBuild [here](https://www.swift.org/blog/the-next-chapter-in-swift-build-technologies/).
