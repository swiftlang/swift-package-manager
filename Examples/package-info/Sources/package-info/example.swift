...
struct Example {
    static func main() async throws {
        ...
        let manifest = try await workspace.loadRootManifest(at: packagePath, diagnosticObserver: observer)

        let package = try await workspace.loadRootPackage(at: packagePath, diagnosticObserver: observer)
