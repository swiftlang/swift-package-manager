...
Swift Package Manager previewed [Swift Build](https://github.com/swiftlang/swift-build) as a replacement for the current native build system in Swift 6.3, and it became the default build system in Swift 6.4. This document outlines the key differences and known issues.


We encourage you to [try](#How-to-use-the-Swift-Build-build-system) the build system in your project and [report any issues](#Reporting-issues) you encounter.
...
- The `swift run --repl` command may fail to import some modules, namely those that depend on system libraries.
