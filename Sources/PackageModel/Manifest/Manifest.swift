...
extension Manifest {
    /// Returns a new `Manifest` copy whose dependency list has been
    /// replaced. Used by workspace-member rewriting.
    package func withDependencies(_ newDependencies: [PackageDependency]) -> Manifest {
        Manifest(
