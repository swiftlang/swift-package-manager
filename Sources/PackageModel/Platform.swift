...
public struct Platform: Equatable, Hashable, Codable, Sendable {
    ...
    public static let macOS: Platform = Platform(name: "macos", oldestSupportedVersion: "12.0")
    public static let macCatalyst: Platform = Platform(name: "maccatalyst", oldestSupportedVersion: "15.0")
    public static let iOS: Platform = Platform(name: "ios", oldestSupportedVersion: "15.0")
    public static let tvOS: Platform = Platform(name: "tvos", oldestSupportedVersion: "15.0")
    public static let watchOS: Platform = Platform(name: "watchos", oldestSupportedVersion: "9.0")
    public static let visionOS: Platform = Platform(name: "visionos", oldestSupportedVersion: "1.0")
    public static let driverKit: Platform = Platform(name: "driverkit", oldestSupportedVersion: "21.0")
