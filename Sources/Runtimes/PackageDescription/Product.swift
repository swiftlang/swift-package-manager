...
extension Product {
    ...
    public struct Deprecation: Sendable, Equatable {
        ...
        public struct Replacement: Sendable, Equatable {
            ...
            ///
            /// - Parameter newName: The name of the replacement product in the same package.
            public static func renamed(to newName: String) -> Replacement {
                return Replacement(storage: .renamed(newName: newName))
            }
