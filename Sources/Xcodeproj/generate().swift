...
*/
public func generate<T where T:XcodeModuleProtocol, T:Module>(dstdir dstdir: String, projectName: String, srcroot: String, modules: [T], externalModules: [T], products: [Product]) throws -> String {
