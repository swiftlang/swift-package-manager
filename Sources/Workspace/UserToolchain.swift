...
public final class UserToolchain: Toolchain {
    ...
    private static func lookup(variable: String, searchPaths: [AbsolutePath]) -> AbsolutePath? {
        return lookupExecutablePath(filename: ProcessInfo.environment[variable], searchPaths: searchPaths)
    }
    ...
    public init(destination: Destination, environment: [String: String] = Process.env) throws {
        ...
        let searchPaths = getEnvSearchPaths(
            pathString: ProcessInfo.environment["PATH"], currentWorkingDirectory: localFileSystem.currentWorkingDirectory)
        ...
        if let pdLibDirEnvStr = ProcessInfo.environment["SWIFTPM_PD_LIBS"] {
