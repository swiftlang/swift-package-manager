...
private struct LocalPackageContainer: PackageContainer {
    ...
    func getDependencies(at version: Version, productFilter: ProductFilter, _ traitConfiguration: TraitConfiguration?) throws -> [PackageContainerConstraint] {
    ...
    func getDependencies(at revisionString: String, productFilter: ProductFilter, _ traitConfiguration: TraitConfiguration?) throws -> [PackageContainerConstraint] {
    ...
    func getUnversionedDependencies(productFilter: ProductFilter, _ traitConfiguration: TraitConfiguration?) throws -> [PackageContainerConstraint] {
        switch dependency?.state {
