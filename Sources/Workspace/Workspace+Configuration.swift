...
extension Workspace.Configuration {
    ...
    public final class BuildCache {
        ...
        public init(
            ...
            self.localCache = .init(path: localBuildCacheFile, fileSystem: fileSystem)
        ...
        public func updateLocal(
            ...
            try self.localCache.update(handler: handler)
            try self.compute()
        ...
        private func compute() throws {
            try self.lock.withLock {
                ...
                let local = try self.localCache.load()
        ...
        private struct StoredBuildCacheConfiguration: Codable {
            ...
            func asConfiguration() throws -> BuildCacheConfiguration {
                ...
                return .init(
                    ...
                    casPath: casPath,
                    sizeLimit: .make(size: self.sizeLimit, percent: self.sizePercent),
