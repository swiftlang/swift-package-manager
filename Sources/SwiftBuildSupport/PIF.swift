...
public enum PIF {
    ...
    public struct BuildSettings: Codable {
        ...
        public func encode(to encoder: Encoder) throws {
            if encoder.userInfo.keys.contains(.encodeForSwiftBuild) {
                return try encodeForSwiftBuild(to: encoder)
            }
        ...
        private func encodeForSwiftBuild(to encoder: Encoder) throws {
...
public struct SwiftBuildFileType: CaseIterable {
    ...
    public static let allCases: [SwiftBuildFileType] = [
        .xcdatamodeld,
        .xcdatamodel,
        .xcmappingmodel,
    ]
    ...
    fileprivate static func fileTypeIdentifier(forPath path: String) -> String {
        ...
        default:
            return pathExtension.flatMap({ pathExtension in
                SwiftBuildFileType.allCases.first(where:{ $0.fileTypes.contains(pathExtension) })
