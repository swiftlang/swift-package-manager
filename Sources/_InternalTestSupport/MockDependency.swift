...
public struct MockDependency {
    ...
    public let traits: [PackageDependency.Trait]

    init(
        deprecatedName: String? = nil,
        location: Location,
        products: ProductFilter = .everything,
        traits: [PackageDependency.Trait] = ["default"]
    ) {
    ...
    public static func fileSystem(path: String, products: ProductFilter = .everything, traits: [PackageDependency.Trait] = ["default"]) -> MockDependency {
        try! MockDependency(location: .fileSystem(path: RelativePath(validating: path)), products: products, traits: traits)
    }

    public static func sourceControl(path: String, requirement: SourceControlRequirement, products: ProductFilter = .everything, traits: [PackageDependency.Trait] = ["default"]) -> MockDependency {
        try! .sourceControl(path: RelativePath(validating: path), requirement: requirement, products: products, traits: traits)
    }

    public static func sourceControl(path: RelativePath, requirement: SourceControlRequirement, products: ProductFilter = .everything, traits: [PackageDependency.Trait] = ["default"]) -> MockDependency {
        MockDependency(location: .localSourceControl(path: path, requirement: requirement), products: products, traits: traits)
    }

    public static func sourceControlWithDeprecatedName(name: String, path: String, requirement: SourceControlRequirement, products: ProductFilter = .everything, traits: [PackageDependency.Trait] = ["default"]) -> MockDependency {
    ...
    public static func sourceControl(url: String, requirement: SourceControlRequirement, products: ProductFilter = .everything, traits: [PackageDependency.Trait] = ["default"]) -> MockDependency {
        .sourceControl(url: SourceControlURL(url), requirement: requirement, products: products, traits: traits)
    }

    public static func sourceControl(url: SourceControlURL, requirement: SourceControlRequirement, products: ProductFilter = .everything, traits: [PackageDependency.Trait] = ["default"]) -> MockDependency {
        MockDependency(location: .remoteSourceControl(url: url, requirement: requirement), products: products, traits: traits)
    }

    public static func registry(identity: String, requirement: RegistryRequirement, products: ProductFilter = .everything, traits: [PackageDependency.Trait] = ["default"]) -> MockDependency {
        .registry(identity: .plain(identity), requirement: requirement, traits: traits)
    }

    public static func registry(identity: PackageIdentity, requirement: RegistryRequirement, products: ProductFilter = .everything, traits: [PackageDependency.Trait] = ["default"]) -> MockDependency {
