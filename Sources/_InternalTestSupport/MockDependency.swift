...
public struct MockDependency {
    ...
    public static func fileSystem(path: String, products: ProductFilter = .everything, traits: Set<PackageDependency.Trait>? = nil) -> MockDependency {
        try! MockDependency(location: .fileSystem(path: RelativePath(validating: path)), products: products, traits: traits)
    }

    public static func sourceControl(path: String, requirement: SourceControlRequirement, products: ProductFilter = .everything, traits: Set<PackageDependency.Trait>? = nil) -> MockDependency {
        try! .sourceControl(path: RelativePath(validating: path), requirement: requirement, products: products, traits: traits)
    }

    public static func sourceControl(path: RelativePath, requirement: SourceControlRequirement, products: ProductFilter = .everything, traits: Set<PackageDependency.Trait>? = nil) -> MockDependency {
        MockDependency(location: .localSourceControl(path: path, requirement: requirement), products: products, traits: traits)
    }

    public static func sourceControlWithDeprecatedName(name: String, path: String, requirement: SourceControlRequirement, products: ProductFilter = .everything, traits: Set<PackageDependency.Trait>? = nil) -> MockDependency {
    ...
    public static func sourceControl(url: String, requirement: SourceControlRequirement, products: ProductFilter = .everything, traits: Set<PackageDependency.Trait>? = nil) -> MockDependency {
        .sourceControl(url: SourceControlURL(url), requirement: requirement, products: products, traits: traits)
    }

    public static func sourceControl(url: SourceControlURL, requirement: SourceControlRequirement, products: ProductFilter = .everything, traits: Set<PackageDependency.Trait>? = nil) -> MockDependency {
        MockDependency(location: .remoteSourceControl(url: url, requirement: requirement), products: products, traits: traits)
    }

    public static func registry(identity: String, requirement: RegistryRequirement, products: ProductFilter = .everything, traits: Set<PackageDependency.Trait>? = nil) -> MockDependency {
        .registry(identity: .plain(identity), requirement: requirement, traits: traits)
    }

    public static func registry(identity: PackageIdentity, requirement: RegistryRequirement, products: ProductFilter = .everything, traits: Set<PackageDependency.Trait>? = nil) -> MockDependency {
