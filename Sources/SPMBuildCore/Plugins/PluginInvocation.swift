        ...
        for target in self.allModules.sorted(by: { $0.name < $1.name }) {
            ...
            for pluginTarget in pluginTargets {
                ...
                class PluginDelegate: PluginInvocationDelegate {
                    ...
                    func pluginDefinedBuildCommand(displayName: String?, executable: AbsolutePath, arguments: [String], environment: ProcessEnvironmentBlock, workingDirectory: AbsolutePath?, inputFiles: [AbsolutePath], outputFiles: [AbsolutePath]) {
                        dispatchPrecondition(condition: .onQueue(delegateQueue))
                    ...
                    func pluginDefinedPrebuildCommand(displayName: String?, executable: AbsolutePath, arguments: [String], environment: ProcessEnvironmentBlock, workingDirectory: AbsolutePath?, outputFilesDirectory: AbsolutePath) -> Bool {
                        dispatchPrecondition(condition: .onQueue(delegateQueue))
