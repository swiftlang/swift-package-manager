...
internal struct PluginContextSerializer {
    ...
    mutating func serialize(xcodeTarget: XcodeProjectRepresentation.Target) throws -> WireInput.XcodeTarget.Id? {
        ...
        inputFiles.append(
            contentsOf: try xcodeTarget.inputFiles.map {
