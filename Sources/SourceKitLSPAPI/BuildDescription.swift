...
public struct BuildDescription {
    ...
    public static func load(
      ...
      observabilityScope: ObservabilityScope
        ...
        // This is quite an abuse of `BuildOperation`, building plugins should really be refactored out of it.
        let operation = BuildOperation(
            ...
            pluginConfiguration: pluginConfiguration,
            scratchDirectory: location.scratchDirectory,
        ...
        return (BuildDescription(plan: plan), bufferedOutput.bytes.description)
    }

    private init(plan: Build.BuildPlan) {
        self.buildPlan = plan
