...
//        try self.httpClient.cancel(deadline: deadline)
    ...
    func _getPackageMetadata(
        ...
        do {
            ...
            throws RegistryError.failedRetrievingReleases(registry: registry, package: package.underlying, error: error)
        }
    }
    ...
    func _getPackageVersionMetadata(
        ...
        let result = self._getRawPackageVersionMetadata(
            registry: registry,
            package: package,
            version: version,
            timeout: timeout,
    ...
    func _getAvailableManifests(
        ...
        let versionMetadata = self._getPackageVersionMetadata(
            registry: registry,
            package: package,
            version: version,
            timeout: timeout,
    ...
    public func publish(
        ...
        do {
            ...
            throw RegistryError.failedPublishing($0)
        }
    }
    ...
    private func checkAvailabilityCache(
        ...
        let result = self.checkAvailability(
            registry: registry,
            observabilityScope: observabilityScope
        )
