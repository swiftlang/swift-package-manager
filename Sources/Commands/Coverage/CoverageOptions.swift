...
public struct CoverageOptions: ParsableArguments {
    ...
    /// If the path of the exported code coverage format should be printed.
    @Option(
        name: [
    ...
    /// If the path of the exported code coverage format should be printed. (deprecated options)
    @Flag(
        name: [
    ...
    @Flag(
        ...
        inversion: .prefixedEnableDisable,
        help: "Determines whether testing measures code coverage. (deprecated. use '--enable-coverage/--disable-coverage' instead)",
    )
...
extension Basics.Diagnostic {
    ...
    package static var deprecatedEnableDisableCoverage: Self {
        .warning(
            "The '--enable-code-coverage' and '--disable-code-coverage' options have been deprecated and will be removed in a future release.  Use '--enable-coverage/--disable-coverage' instead."
        )
