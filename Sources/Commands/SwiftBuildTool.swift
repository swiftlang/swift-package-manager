...
public struct SwiftBuildTool: SwiftTool {
    ...
    private func usage(_ print: (String) -> Void = { print($0) }) {
        ...
        print("")
        print("MODES:")
        print("  -c, --configuration <value>   Build with configuration (default: debug|release)")
        print("  --clean <mode>                Delete artifacts (default: build|dist)")
        print("")
        print("OPTIONS:")
        ...
        print("  --color <mode>           Specify color mode (default: auto|always|never)")
