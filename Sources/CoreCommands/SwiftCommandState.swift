...
public final class SwiftCommandState {
    ...
    public func getActiveWorkspace(emitDeprecatedConfigurationWarning: Bool = false) throws -> Workspace {
        ...
        let isXcodeBuildSystemEnabled = self.options.build.buildSystem.useXcodeBuildEngine
        let workspace = try Workspace(
            ...
            configuration: .init(
                ...
                shouldCreateMultipleTestProducts: toolWorkspaceConfiguration.wantsMultipleTestProducts || options.build.buildSystem.useXcodeBuildEngine,
    ...
    private func _buildParams(
        ...
        return try BuildParameters(
            ...
            isXcodeBuildSystemEnabled: options.build.buildSystem.useXcodeBuildEngine,
