...
//                            "SystemLib",
                        ...
                        .init(name: "cfoo"),
//                        .init(name: "SystemLib", type: .system, pkgConfig: "pkgConfig"),
...
//                        .init(name: "SystemLib", type: .system, pkgConfig: "pkgConfig"),
    ...
    func testSystemLibraryTargetsCantFindPCFile() {
        let fs = InMemoryFileSystem(emptyFiles:
            "/Foo/Sources/SystemLib/module.modulemap"
        )
        ...
        let graph = loadPackageGraph(
            ...
            manifests: [
                Manifest.createManifest(
                    ...
                    packageKind: .root,
                    targets: [
                        .init(name: "SystemLib", type: .system, pkgConfig: "SystemLib"),
                    ]),
            ]
        )
        ...
        DiagnosticsEngineTester(diagnostics) { diagnostics in
            diagnostics.check(diagnostic: "couldn't find PC file", behavior: .warning)
        }
    }
                ...
                project.checkAggregateTarget("PACKAGE-TARGET:SystemLib2") { target in
                    ...
                    target.checkAllImpartedBuildSettings { settings in
                        XCTAssertEqual(settings[.OTHER_CFLAGS], [
                            ...
                            "-I/path/to/inc",
                            "-I/Users/david/Projects/swift/swiftpm/Tests/XCBuildSupportTests/Inputs"
                        ])
                        ...
                        XCTAssertEqual(settings[.OTHER_SWIFT_FLAGS], [
                            ...
                            "-Xcc", "-I/path/to/inc",
                            "-Xcc", "-I/Users/david/Projects/swift/swiftpm/Tests/XCBuildSupportTests/Inputs"
                        ])
                    }
                }
            }
                ...
                Manifest.createManifest(
                    ...
                    targets: [
                        .init(name: "foo", settings: [
                            .init(tool: .c, name: .define, value: ["ENABLE_BEST_MODE"]),
                            .init(tool: .cxx, name: .headerSearchPath, value: ["some/path"], condition: .init(platformNames: ["macos"])),
                            .init(tool: .linker, name: .linkedLibrary, value: ["z"], condition: .init(config: "debug")),
                            .init(tool: .swift, name: .unsafeFlags, value: ["-secret", "value"], condition: .init(platformNames: ["macos", "linux"], config: "release")),
                        ]),
        ...
        PIFTester(pif) { workspace in
            workspace.checkProject("PACKAGE:/Foo") { project in
                project.checkTarget("PACKAGE-PRODUCT:foo") { target in
                    target.checkBuildConfiguration("Debug") { configuration in
                        configuration.checkBuildSettings { settings in
                            ...
                            XCTAssertEqual(settings[.HEADER_SEARCH_PATHS, for: .macOS], ["$(inherited)", "some/path"])
                ...
                project.checkTarget("PACKAGE-TARGET:FooLib") { target in
                    ...
                    // TODO: Uncomment once manifest build settings are correctly applied to imparted build settings.
//                    target.checkImpartedBuildSettings { settings in
//                        XCTAssertEqual(settings[.GCC_PREPROCESSOR_DEFINITIONS], ["$(inherited)", "ENABLE_BEST_MODE"])
//                        XCTAssertEqual(settings[.HEADER_SEARCH_PATHS], nil)
//                        XCTAssertEqual(settings[.HEADER_SEARCH_PATHS, for: .macOS], ["$(inherited)", "some/path"])
...
extension PIFBuilderParameters {
    static func mock(
        platform: PackageModel.Platform = .macOS,
...
private struct MockToolchain: Toolchain {
    ...
    func getClangCompiler() throws -> AbsolutePath { AbsolutePath("/fake/path/to/clang") }
    func _isClangCompilerVendorApple() throws -> Bool? { return true }
}
