                ...
                project.checkTarget("PACKAGE-PRODUCT:FooTests") { target in
                    ...
                    target.checkBuildConfiguration("Debug") { configuration in
                        ...
                        configuration.checkAllBuildSettings { settings in
                            ...
                            XCTAssertEqual(settings[.WATCHOS_DEPLOYMENT_TARGET], computeXCTestMinimumDeploymentTarget(for: .watchOS).versionString)
                            XCTAssertEqual(settings[.IPHONEOS_DEPLOYMENT_TARGET], computeXCTestMinimumDeploymentTarget(for: .iOS).versionString)
                            XCTAssertEqual(settings[.TVOS_DEPLOYMENT_TARGET], computeXCTestMinimumDeploymentTarget(for: .tvOS).versionString)
                            XCTAssertEqual(settings[.MACOSX_DEPLOYMENT_TARGET], computeXCTestMinimumDeploymentTarget(for: .macOS).versionString)
                        }
                    }
