...
//     @Test
//     func productAndTarget() async throws {
...
//     }
    ...
    func buildStartMessage(
        ...
        try await fixture(name: "DependencyResolution/Internal/Simple") { fixturePath in
            let result = try await execute([], packagePath: fixturePath, configuration: configuration, buildSystem: buildSystem)
    ...
    @Test(
        ...
        .skipHostOS(.windows, "possible long filename issue: needs investigation"),
        arguments: SupportedBuildSystemOnPlatform,
    )
