...
extension PackageCommandTests.PackageReportCommandTests {
    ...
    struct ProductDeprecation {
        ...
        struct DirectViolationsTests {
            ...
            func reportsDirectDeprecatedProductsInJson(
                ...
                try await fixture(name: "Miscellaneous/DeprecatedProducts/") { fixturePath in
                    try await expectThrowsCommandExecutionError(
                        ...
                        guard let root = try? JSONSerialization.jsonObject(with: data) as? [String: Any],
                            ...
                            Issue.record("report output is not valid JSON. stdout:\n\(error.stdout)")
                            return
                        }
            ...
            func reportsDirectDeprecatedProductsInText(
                buildSystem: BuildSystemProvider.Kind,
            ) async throws {
                try await fixture(name: "Miscellaneous/DeprecatedProducts/") { fixturePath in
        ...
        struct ExitCodeSemanticsTests {
            ...
            func exitsNonZeroWhenDeprecatedProductsFound(
                buildSystem: BuildSystemProvider.Kind,
            ) async throws {
                try await fixture(name: "Miscellaneous/DeprecatedProducts/") { fixturePath in
            ...
            func exitsZeroWithAllowDeprecationsFlag(
                buildSystem: BuildSystemProvider.Kind,
            ) async throws {
                try await fixture(name: "Miscellaneous/DeprecatedProducts/") { fixturePath in
            ...
            func rejectsInvalidIncludeTransitiveMode(
                buildSystem: BuildSystemProvider.Kind,
            ) async throws {
                try await fixture(name: "Miscellaneous/DeprecatedProducts/") { fixturePath in
                    try await #expect(throws: (any Error).self) {
        ...
        struct CleanPackageTests {
            ...
            func onCleanPackageEmitsEmptyReport(
                buildSystem: BuildSystemProvider.Kind,
            ) async throws {
                // Reporting on `producer` directly: no producer target has a
        ...
        struct TransitiveReachableViolationsTests {
            ...
            func onConsumerTransitiveReportsNothingByDefault(
                buildSystem: BuildSystemProvider.Kind,
            ) async throws {
            ...
            func onConsumerTransitiveWithBareIncludeTransitiveReportsReachable(
                buildSystem: BuildSystemProvider.Kind,
            ) async throws {
            ...
            func includeTransitiveEqualsReachableIsSameAsBare(
                buildSystem: BuildSystemProvider.Kind,
            ) async throws {
            ...
            func onConsumerTransitiveTextEmitsReachableSection(
                buildSystem: BuildSystemProvider.Kind,
            ) async throws {
                try await fixture(name: "Miscellaneous/DeprecatedProducts/") { fixturePath in
                    await expectThrowsCommandExecutionError(
        ...
        struct TransitiveUnreachableViolationsTests {
            ...
            func withIncludeTransitiveAllReportsUnreachableOnConsumer(
                buildSystem: BuildSystemProvider.Kind,
            ) async throws {
                // Reporting on `consumer` with --include-transitive=all: MyApp and
            ...
            func withIncludeTransitiveNonReachableSkipsReachable(
                buildSystem: BuildSystemProvider.Kind,
            ) async throws {
                // Reporting on `consumer-transitive` with
            ...
            func includeTransitiveReachableOmitsUnreachable(
                buildSystem: BuildSystemProvider.Kind,
            ) async throws {
                // Reporting on `consumer-transitive` with
            ...
            func withIncludeTransitiveAllTextEmitsUnreachableSection(
                buildSystem: BuildSystemProvider.Kind,
            ) async throws {
                try await fixture(name: "Miscellaneous/DeprecatedProducts/") { fixturePath in
                    await expectThrowsCommandExecutionError(
