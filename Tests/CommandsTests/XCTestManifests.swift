...
extension MultiRootSupportTests {
    // DO NOT MODIFY: This is autogenerated, use:
    //   `swift test --generate-linuxmain`
    // to regenerate.
    static let __allTests__MultiRootSupportTests = [
        ("testWorkspaceLoader", testWorkspaceLoader),
    ]
}
...
public func __allTests() -> [XCTestCaseEntry] {
    return [
        ...
        testCase(MultiRootSupportTests.__allTests__MultiRootSupportTests),
