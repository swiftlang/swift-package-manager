...
extension WorkspaceTests {
    ...
    static let __allTests__WorkspaceTests = [
        ...
        ("testIsResolutionRequired_empty", testIsResolutionRequired_empty),
        ("testIsResolutionRequired_inputNotSatisfiable", testIsResolutionRequired_inputNotSatisfiable),
        ("testIsResolutionRequired_managedDependenciesOutOfSync", testIsResolutionRequired_managedDependenciesOutOfSync),
        ("testIsResolutionRequired_notRequired", testIsResolutionRequired_notRequired),
