...
extension ManifestTests {
    ...
    // to regenerate.
    static let __allTests__ManifestTests = [
        ("testRequiredDependencies", testRequiredDependencies),
        ("testRequiredTargets", testRequiredTargets),
    ]
}
...
public func __allTests() -> [XCTestCaseEntry] {
    return [
        testCase(ManifestTests.__allTests__ManifestTests),
