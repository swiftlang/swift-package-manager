...
final class PackageIdentityTests: XCTestCase {
    ...
    func testFTPScheme() {
        XCTAssertEqual(
            ...
            PackageIdentity("example.com/mona/LinkedList")
        )
    }
    ...
    func testHTTPSSchemeWithGitSuffixAndSwiftExtension() {
        XCTAssertEqual(
            ...
            PackageIdentity("example.com/mona/LinkedList.swift")
        )
    }
    ...
    func testHTTPSSchemeWithPercentEncoding() {
        XCTAssertEqual(
            ...
            PackageIdentity("example.com/mona/🔗List")
        )
    }
    ...
    func testHTTPSSchemeWithInvalidPercentEncoding() {
        XCTAssertEqual(
            ...
            PackageIdentity("example.com/mona/100%")
        )
    }
    ...
    func testHTTPSSchemeWithInternationalizedDomainName() throws {
        ...
        XCTAssertEqual(
            ...
            PackageIdentity("schlüssel.tld/mona/LinkedList")
        )
    }
    ...
    func testImplicitSSHSchemeWithColonInPathComponent() {
        XCTAssertEqual(
            ...
            PackageIdentity("example.com/mona/Linked:List")
        )
    }
}
