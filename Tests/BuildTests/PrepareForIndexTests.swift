...
class PrepareForIndexTests: XCTestCase {
    func testPrepare() async throws {
        try skipOnWindowsAsTestCurrentlyFails(because: "coreCommands.count = 0 instead of 1. Possibly related to https://github.com/swiftlang/swift-package-manager/issues/8511")
    ...
    func testEnableTestingDebuConfiguration() async throws {
    ...
    func testPrepareNoLazy() async throws {
        try skipOnWindowsAsTestCurrentlyFails(because: "coreCommands.count = 0 instead of 1")
