...
final class PluginsBuildPlanTests: XCTestCase {
    func testBuildToolsDatabasePath() async throws {
        try skipOnWindowsAsTestCurrentlyFails(because: "Fails to build the project to due to incorrect Path handling.  Possibly related to https://github.com/swiftlang/swift-package-manager/issues/8511")
