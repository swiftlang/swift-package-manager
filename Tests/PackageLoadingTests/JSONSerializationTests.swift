...
class JSONSerializationTests: XCTestCase {
    ...
    func testProducts() {
        ...
        product = .Library(name: "exe", targets: ["foo", "bar"])
        XCTAssertEqual(product.toJSON().toString(), "{\"name\": \"exe\", \"product_type\": \"lib\", \"targets\": [\"foo\", \"bar\"], \"type\": null}")

        product = .Library(name: "exe", type: .static, targets: ["foo", "bar"])
        XCTAssertEqual(product.toJSON().toString(), "{\"name\": \"exe\", \"product_type\": \"lib\", \"targets\": [\"foo\", \"bar\"], \"type\": \"static\"}")

        product = .Library(name: "exe", type: .dynamic, targets: ["foo", "bar"])
        XCTAssertEqual(product.toJSON().toString(), "{\"name\": \"exe\", \"product_type\": \"lib\", \"targets\": [\"foo\", \"bar\"], \"type\": \"dynamic\"}")
    }
