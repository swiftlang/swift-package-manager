...
class JSONSerializationTests: XCTestCase {
    ...
    func testSimple() {
        ...
        assertEqual(package: package, expected: "{\"dependencies\": [], \"exclude\": [], \"name\": \"Simple\", \"package.targets\": []}")
    }
    ...
    func testPkgConfig() {
        ...
        assertEqual(package: package, expected: "{\"dependencies\": [], \"exclude\": [], \"name\": \"PkgPackage\", \"package.providers\": [{\"Brew\": \"BrewPackage\"}, {\"Apt\": \"AptPackage\"}], \"package.targets\": [], \"pkgConfig\": \"PkgPackage-1.0\"}")
    }

    func testExclude() {
        let package = Package(name: "Exclude", exclude: ["pikachu", "bulbasaur"])
        assertEqual(package: package, expected: "{\"dependencies\": [], \"exclude\": [\"pikachu\", \"bulbasaur\"], \"name\": \"Exclude\", \"package.targets\": []}")
    }
    ...
    func testTargets() {
        ...
        assertEqual(package: package, expected: "{\"dependencies\": [], \"exclude\": [], \"name\": \"Targets\", \"package.targets\": [{\"dependencies\": [], \"name\": \"One\"}, {\"dependencies\": [\"One\"], \"name\": \"Two\"}]}")
    }
