...
final class MiscellaneousTestCase: XCTestCase {
    ...
    */
    ...
    func testUnicode() async throws {
        try XCTSkipOnWindows(because: "Filepath too long error, needs investigating")
    ...
    func testTestsCanLinkAgainstExecutable() async throws {
        try XCTSkipOnWindows(because: "stdout is empty, https://github.com/swiftlang/swift-package-manager/pull/8549 might fix")
    ...
    func testPluginGeneratedResources() async throws {
        try XCTSkipOnWindows(because: "error: The operation could not be completed. The file doesn’t exist.")
