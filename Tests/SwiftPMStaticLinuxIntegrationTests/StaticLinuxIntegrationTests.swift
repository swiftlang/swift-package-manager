...
private struct StaticLinuxIntegrationTests {
    ...
    func basicSwiftExecutable(buildSystem: BuildSystemProvider.Kind) async throws {
        try await fixture(name: "ValidLayouts/SingleModule/ExecutableNew") { fixturePath in
            ...
            let arch: String
            #if os(Linux)
            arch = try UserToolchain.default.targetTriple.archName
            #else
            arch = "x86_64"
            #endif
            ...
            try #require(buildOutput.stdout.contains("Build complete"))
            ...
            try #require(localFileSystem.exists(binary), "Expected binary at \(binary)")
    ...
    @Test(
        .requiresStaticLinuxSwiftSDK,
        .issue("https://github.com/swiftlang/swift-package-manager/issues/10237", relationship: .verifies),
